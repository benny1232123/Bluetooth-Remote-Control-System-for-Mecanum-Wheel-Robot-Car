...
//#define LED      15        //背光控制引脚        PB9
//#define LCD_CS   13       //片选引脚            PB11
//#define LCD_RS    9      //寄存器/数据选择引脚 PB10 
//#define LCD_RST  11       //复位引脚            PB12

#define GPIO_TYPE  GPIOF  //GPIO组类型
#define LCD_LED      GPIO_Pin_0        //背光控制引脚        PB9
#define LCD_CS   2       //片选引脚            PB11
#define LCD_RS    6      //寄存器/数据选择引脚 PB10 
#define LCD_RST  4       //复位引脚            PB12

//#define GPIO_TYPE  GPIOF  //GPIO组类型
//#define LCD_LED      GPIO_Pin_1        //背光控制引脚        PB9
//#define LCD_CS   7       //片选引脚            PB11
//#define LCD_RS    3      //寄存器/数据选择引脚 PB10 
//#define LCD_RST  5       //复位引脚            PB12
